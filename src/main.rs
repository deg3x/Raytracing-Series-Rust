...
fn main() {
    ...
    let mat_left = Material {type_info: MaterialType::Dielectric, albedo: Color01::new(0.8, 0.8, 0.8), fuzziness: 0.3, refraction_idx: 1.50};
    let mat_left_in = Material {type_info: MaterialType::Dielectric, albedo: Color01::new(0.8, 0.8, 0.8), fuzziness: 0.3, refraction_idx: 1.0 / 1.5};
    ...
    world.add(Box::new(Sphere {center: Vec3::new(-1.0, 0.0, -1.0), radius: 0.4, material: mat_left_in}));
