...
fn main() {
    ...
    let mat_ground = Material {type_info: MaterialType::Lambert, albedo: Color01::new(0.8, 0.8, 0.0), fuzziness: 0.0};
    let mat_center = Material {type_info: MaterialType::Lambert, albedo: Color01::new(0.1, 0.2, 0.5), fuzziness: 0.0};
    let mat_left = Material {type_info: MaterialType::Metal, albedo: Color01::new(0.8, 0.8, 0.8), fuzziness: 0.3};
    let mat_right = Material {type_info: MaterialType::Metal, albedo: Color01::new(0.8, 0.6, 0.2), fuzziness: 0.8};
